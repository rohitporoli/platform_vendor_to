...
#
# Time of this snapshot: 20151029-1511
#
...
git checkout 422476085520c9c530436d51977b1a384c650f0f

cd $ANDROID_BUILD_TOP/bootable/recovery-twrp/
git checkout 8499b08b9a16aa0e9e8e90582e8fcfd92b1ae3b1

cd $ANDROID_BUILD_TOP/build/
git checkout 89c9a68641f89f33e72f0823bfb1da0134ae097c

cd $ANDROID_BUILD_TOP/cts/
git checkout d80b1818abfdfe4e7f37fd233e631af38341158c
...
git checkout 6ddd064764deee9968dba06dce8fe791e8e8e150
...
git checkout ced3cd485ccbc602f9c625a7b5cd970d5d09f26b

cd $ANDROID_BUILD_TOP/device/lge/g3-common/
git checkout 4dd0597bcc6c5794ef50366085df7b1b9686662e

cd $ANDROID_BUILD_TOP/device/qcom/common/
git checkout 6948d776cb4030208acd910ce236d0d6978b96b6
...
git checkout 62334e7e9e537be50c6c5a139b6cc328076d1a26

cd $ANDROID_BUILD_TOP/device/samsung/qcom-common/
git checkout 3a26861e3243b4cbcbd40f70963f006aac7dd1b8
...
git checkout 6792cf6361ff339e336287affb0bfe54bf6957a9
...
git checkout cd9e00865fcb6abe79dd1e4db40e803b35696d2a
...
git checkout 23166cc24fb2fce697edca27739a8283d1aae29d
...
git checkout e25d1db6fb8cd5afff1f7434e8e283a28b0d2f8f
...
git checkout ccfbcd4c8b379966047ed28a0a07e1a40aae8c80
...
git checkout 6fb74479d3b76983dff50724e501f12d0b046522
...
git checkout 3e1cfb04b7f009d220e3a9286be5e88a42d61d2b
...
git checkout bb36b5b08eaf4122ad2aa9f8ceaefa923dce6429
...
git checkout 832d93744cccf1f056f7ecdad6041e91148e9260
...
git checkout 3cbc6eb7ddee926506117f73f4f696ee1ce097ae
...
git checkout 7902b1791bbc63de38d71743f7428f969af3b3ed
...
git checkout bede54fe413d05c66328018dc548b7f09dde270e

cd $ANDROID_BUILD_TOP/frameworks/base/
git checkout 06c9bb105c3c79b851ad3aaff38e041193a86588
...
git checkout e4759c30aac75fbbb4dddf30206fde8f5b5614b2
...
git checkout afc21fbcc1d2ae570ff168ff0591c20c1e54923c
...
git checkout 8e8cc0127f21b2182e5a811917b4dee1821700c0
...
git checkout 86246ea4256338f0eaefb309f7909f82947b7bd5
...
git checkout f03bd6498232beafec79b2eecf71725bcab2270e
...
git checkout 8e39456f69d690c0460437a091468e559893dd2e
...
git checkout 215b75ef256dc7f30dd80479915e69ddeb4b599a
...
git checkout d6e13408a9d5da3aafb6a6984ca3d425cfcc3413
...
git checkout ead0bb0cef18ab8bf6ed2bee0bbc149f5b0d2a15

cd $ANDROID_BUILD_TOP/kernel/samsung/d2/
git checkout 0702456ea8f88e275f1bb32532d9a6d20f237557
...
git checkout 47886c3f20bab785151604be0de0810e3c7d5ce5
...
git checkout bebcbe6dc11099be7206b516176be3b518894cdc
...
git checkout 20cba870ad45183597a3f6f03664b7831c658f17

cd $ANDROID_BUILD_TOP/packages/apps/BluetoothExt/
git checkout ef81181d8e1aeaab9533628366df5344c43eba04

cd $ANDROID_BUILD_TOP/packages/apps/Browser/
git checkout 99dd14b1dc6e36742480be90b6a7bad6aa339955

cd $ANDROID_BUILD_TOP/packages/apps/CMBugReport/
git checkout a00f6af14fa5c280d442ab531b00b0f53c4598c8

cd $ANDROID_BUILD_TOP/packages/apps/CMFileManager/
git checkout ab89abc59b543760cfb0ccd6d20ab6c76b643972

cd $ANDROID_BUILD_TOP/packages/apps/Calculator/
git checkout 210cdb65da98fb530fc91cb52ee5be3e4c33dfd1

cd $ANDROID_BUILD_TOP/packages/apps/Calendar/
git checkout de4e6ca748c5c4e3ee9485e7511bca18e7aee264

cd $ANDROID_BUILD_TOP/packages/apps/Camera2/
git checkout 6b1703749435f2e518018d593ce172a3ec034cac

cd $ANDROID_BUILD_TOP/packages/apps/CellBroadcastReceiver/
git checkout af5a0602b73c7fcdd7b7de9a3f43e922e0c1ebaf
...
git checkout dcfa888e096eec6fadd7de84b175cf6ad5f226df

cd $ANDROID_BUILD_TOP/packages/apps/ContactsCommon/
git checkout aa5f43189b809a4741f9fd671876625390220afa

cd $ANDROID_BUILD_TOP/packages/apps/DeskClock/
git checkout 3cc92a9e4edf8f28b6f0633b1be60d947b275741

cd $ANDROID_BUILD_TOP/packages/apps/Dialer/
git checkout 486941bfcc15ed6565231787f93a4f98f4cff816

cd $ANDROID_BUILD_TOP/packages/apps/Eleven/
git checkout c544b6a2eb234db26bc423654fc4a085bb495597

cd $ANDROID_BUILD_TOP/packages/apps/Email/
git checkout b9984debe6b72f06cbf9bf72baa54b80f017eb38
...
git checkout 7127cd4ec0458dc591a8982bb0efebf6ad11d819
...
git checkout 85ab64dd6d8a9a43a8ddcd859113b3198d5c7113
...
git checkout 76ba8cb6819d57ef960c0667aa1e9a5139b79f9b

cd $ANDROID_BUILD_TOP/packages/apps/Mms/
git checkout 8297e7bf4f8361f50fcbbadf5126ee7596715e88
...
git checkout b97ebfa18b293c2073a2085317409680f4fe2dfd

cd $ANDROID_BUILD_TOP/packages/apps/Profiles/
git checkout aa39fbc8da711b5e1c109187a6aa23253ff54be7
...
git checkout b27de88137737ee571b1500b10cbbf5042b11953
...
git checkout 9973e42098d11f01c72527ca79782545f8d84c88
...
git checkout ac9810c84d730b12a48a011e19e14b2227c6278e
...
git checkout 71475d25c04042e6de57bf4283013a622e57e54e

cd $ANDROID_BUILD_TOP/packages/apps/ThemeChooser/
git checkout 7d117f9b628157e4e343d14e4293f48795e2ef8f

cd $ANDROID_BUILD_TOP/packages/apps/TvSettings/
git checkout 19d218cad68687255ea6c127ce9a6a4e0be1321e

cd $ANDROID_BUILD_TOP/packages/apps/UnifiedEmail/
git checkout 8ef4be4355442fd419b2b2be2501db2ae9b5b68f
...
git checkout 305b05097b306582f73c2db29854a89916faef5a
...
git checkout d64cb33d35423d6bf10d3244326acc7ca37d824b
...
git checkout 2fdddefd69024fe0945bd2dccc1088e107db60a8
...
git checkout 537889fe2a36767d23eedc6dd08c0826e99d2dd0

cd $ANDROID_BUILD_TOP/packages/services/Telecomm/
git checkout 9638535ad2c27115927446aa4453ff089de04f0f

cd $ANDROID_BUILD_TOP/packages/services/Telephony/
git checkout 70674fdb42e7b781ff71c801b45144bb246e9bec
...
git checkout e7e5f961c85d6f9bcab3ed5d28297e08c6485f82
...
git checkout 37454042dc53b4e2c2b601ba40f963671f16f10e

cd $ANDROID_BUILD_TOP/packages/wallpapers/PhotoPhase/
git checkout 474f79cec2d60b0412963913d54761d2bb7f5f38
...
git checkout 090c6d27b42fb64729f071c6f199b10db58c7296
...
git checkout 655e15139536b15bd18ad56bf3184d4d837ea826
...
git checkout 441cdbaabc4b3a0664edb6aa3f0a9ba16d2f9205
...
git checkout afd9cff1e08b2bbbe9fac9414ba8712f601dfd34
...
git checkout f149756689266bcf9d400439f9552db7ea2d89f2
...
git checkout 694c14c1a21c9be51e134cf66761744812b7d391

cd $ANDROID_BUILD_TOP/vendor/lge/
git checkout f3fa5993979c1f1a4f1af91505c6201d4b2c1bac

cd $ANDROID_BUILD_TOP/vendor/samsung/
git checkout 2f501be3c29357a750747237e9cdec2e6792d2b6

cd $ANDROID_BUILD_TOP/vendor/to/
git checkout 925be7ea3309eae7ce7db696c7f730761f09eb46
